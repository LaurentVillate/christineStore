  ...
  <header>
    <nav class="nav nav-pills flex-column flex-sm-row">
      <div class="d-flex flex-grow-1">
        ...
        <a class="nav-link" href="#"><i class="bi bi-geo-alt"></i> 13, rue d'Alençon – 61130 Bellême</a>
        <a class="nav-link" href="#"><i class="bi bi-telephone-fill"></i> 02 33 85 74 53</a>
      </div>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      ...
      <a class="navbar-brand d-flex flex-grow-1" href="#">
        <img src="public/img/christine-logo-white-small.png" alt="">
      </a>
